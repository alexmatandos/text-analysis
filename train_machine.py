...
#pickle saves the machine learning tool for 'boss_program.py'
#with open("machine.pickle", "wb") as f:
#	pickle.dump(machine, f)
#
#with open("count_vectorizer_transformer.pickle", "wb") as f:
...
#rather than doing the above we can do the following, but remember that some packages may not be able to use 'pickle':
...
#INSTEAD OF USING 'pickle' USE 'dill' AND ALL PACKAGES CAN BE USED!
